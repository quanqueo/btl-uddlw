<?php
    ...
    if(isset($_SESSION['admin'])){
        ...
        if(isset($_POST['btn_login'])){
            $admin = getPost('username');
            $pass = getPost('password');
            $sql = "SELECT * FROM `account` WHERE `username` = '$admin' and `password` = '$pass' and `admin` = 1";
                ...
                <div class="login100-form validate-form">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="container-login100-form-btn">
                            <input type="submit" value="Đăng nhập" class="btn btn-success" id="submit" name="btn_login" onclick="validate()" />
                        </div>
                        <!--=====LINK TÌM MẬT KHẨU======-->
                    ...
                    <div class="text-center p-t-70 txt2">
                        Website đấu thầu trực tuyến <i class="far fa-copyright" aria-hidden="true"></i>
                        <script type="text/javascript">document.write(new Date().getFullYear());</script> <a
                            class="txt2" href="#"> Code bởi Nhóm 5 </a>
                    </div>
                </div>
            </div>
        </div>
